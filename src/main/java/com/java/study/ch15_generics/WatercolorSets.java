package com.java.study.ch15_generics;//: generics/WatercolorSets.java
import com.java.study.ch15_generics.watercolors.*;
import java.util.*;
import static net.mindview.util.Print.*;
import static net.mindview.util.Sets.*;
import static com.java.study.ch15_generics.watercolors.Watercolors.*;
